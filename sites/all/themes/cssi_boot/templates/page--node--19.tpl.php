...
<header id="navbar" role="banner" class="<?php print $navbar_classes; ?>"> 
  ...
  <div class="row full-width banner minibar">
    <div class="minibanner-white">
      <section>
        <?php if (!empty($page['minibarlogo'])): ?>
        <div class="col-sm-12 columns left-banner-block"> <?php print render($page['minibarlogo']); ?> </div>
        <?php endif; ?>
        <?php if (!empty($page['search'])): ?>
        <div class="col-sm-4 columns right-banner-block"> <?php print render($page['search']); ?> </div>
        <?php endif; ?>
      </section>
    </div>
  </div>
  ...
  <div class="row full-width banner minibarslogan">
    <section class="row <?php print $alt_header_classes; ?>">
      <div class="col-sm-12 columns slogan-banner-block"> <?php print render($page['minibarslogan']); ?> </div>
    </section>
  </div>
  <?php endif; ?>
  <!--end nci_slogan-->
  ...
  <div class="navbar-collapse collapse border right">
    <nav role="navigation">
  ...
  <div class="row">
    <div class="main-content">
      ...
      <section<?php print $content_column_class; ?>>
        ...
        <iframe style="border: #555 solid 0;margin-top:10px;width:100%;" id="tl-timeline-iframe" height="800" src="/about/timeline/output" title="CSSI Timeline"></iframe>
...
window.attachEvent("onmouseup", tlMouseupFunc);
        ...
        <!--<a href="/timeline-assets/timeline.html" target="_blank">View Fullscreen</a>--> 
        <a href="/about/timeline/output" target="_blank">View Fullscreen</a> </section>
    ...
    <footer class="footer two container"> <?php print render($page['footer']); ?> </footer>
  </div>
</div>
